...
artifact_hash, tarball_path = debootstrap(arch, image; archive, packages, release) do rootfs, chroot_ENV
    ...
    docker_buildx_cmd = """
    # Download the buildx binary to ~/.docker/cli-plugins, rename it as docker-buildx and make it executable for all users
    mkdir -p ~/.docker/cli-plugins
    curl -L https://github.com/docker/buildx/releases/download/v0.9.1/buildx-v0.9.1.linux-amd64 --output ~/.docker/cli-plugins/docker-buildx
